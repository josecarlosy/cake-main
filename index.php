            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="about__text">
                        ...
                        <p>The "Jose Cake Shop" is a Kenyan Brand that started as a small personal business. The owners are
                        </p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-7">
                    <div class="map__inner">
                        <h6>Nairobi</h6>
                        <ul>
                            <li>CBD Tom mboya street, Nairobi</li>
                            <li>6karanjajoseph@gmail.com</li>
                            <li>+254705592192</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <p class="copyright__text text-white"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                          Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This website is a property of jose cake shop <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">joscarlosy</a>
