...
<!--script-->
      ...
      <div id="content">
		...
		<table style="margin:auto; text-align: center;">
			<h1 style="color:#0000ff; font-size:30px;"><b>Cellphone Brands:</b></h1>
				<tr style="line-height:30px;">
					<td><a href="products_samsung.php"><img src="images/brand/samsung.jpg" class="border_brand"></a></td>
					<td><a href="products_alcatel.php"><img src="images/brand/alcatel.jpg" class="border_brand"></a></td>
					<td><a href="products_nokia.php"><img src="images/brand/nokia.jpg" class="border_brand"></a></td>
					<td><a href="products_cherry.php"><img src="images/brand/cherry.jpg" class="border_brand"></a></td>
					<td><a href="products_myphone.php"><img src="images/brand/myphone.jpg" class="border_brand"></a></td>
				</tr>
		</table>
		
			<h1 style="color:#0000ff; margin-top:50px; font-size:30px;"><b>Products:</b></h1>
			...
			<h1 style="color:#0000ff; font-size:30px;"><b>Services:</b></h1>
					<table border="0" cellpadding="1" cellspacing="1">
						<tr>
						</tr>
						<tr>
							<td>
								<ul>
									<li>Cellphone Repair</li>
									<li>Cellphone Unlocking</li>
								</ul>
							</td>
						</tr>
					</table>		
			...
			<h1 style="color:#0000ff; font-size:30px;"><b>Computers/Laptops:</b></h1>
					<table border="0" cellpadding="1" cellspacing="1">
						<tr>
						</tr>
						<tr>
			...
			<h1 style="color:#0000ff; font-size:30px;"><b>Digital Cameras:</b></h1>
					<table border="0" cellpadding="1" cellspacing="1">
						<tr>
						</tr>
						<tr>
