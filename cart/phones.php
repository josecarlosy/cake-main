...
<!--script-->
	  ...
	  <div id="sidebar_container">
		...
		<div class="side_bar">	
			<a href="phones.php" class="sidebar_menu_active"><img src="images/icon/phonesicon.png" width="33" alt="Phones">&nbsp;&nbsp;Phones</a>
		</div>
		<div class="side_bar">	
...
$result= mysql_query("select * from products where product_type='Phones' and product_status='Available' order by product_id ASC") or die (mysql_error());
