...
<!--script-->
	  ...
	  <div id="sidebar_container">
		...
		<div class="side_bar">	
			<a href="accessories.php" class="sidebar_menu_active"><img src="images/icon/accessoriesicon2.png" width="33" alt="Phones">&nbsp;&nbsp;Accessories</a>
		</div>
		<div class="side_bar">	
...
$result= mysql_query("select * from products where product_type='Accessories'  and product_status='Available' order by product_id ASC") or die (mysql_error());
