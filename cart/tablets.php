...
<!--script-->
	  ...
	  <div id="sidebar_container">
		...
		<div class="side_bar">	
			<a href="tablets.php" class="sidebar_menu_active"><img src="images/icon/tableticon.png" width="33" alt="Phones">&nbsp;&nbsp;Tablets</a>
		</div>
		<div class="side_bar">	
...
$result= mysql_query("select * from products where product_type='Tablets'  and product_status='Available' order by product_id ASC") or die (mysql_error());
