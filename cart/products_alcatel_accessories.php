...
<caption><div class="pagination">
  ...
  <ul>
    ...
    <li><a href="products_alcatel_phones.php"><font color="#000000">Phones</font></a></li>
    ...
    <li class="active"><a href="products_alcatel_accessories.php"><font color="#000000">Accessories</font></a></li>
  </ul>
</div></caption>
...
$result= mysql_query("select * from products where product_brand='Alcatel' and product_type='Accessories' and product_status='Available' order by product_id ASC ") or die (mysql_error());
