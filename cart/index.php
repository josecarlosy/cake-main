...
include ('admin/includes/dbcontroller.php');
...
$result= mysql_query("select * from products where product_type='Smartphones' and product_status='Available' and product_brand='Samsung' order by product_id DESC") or die (mysql_error());
...
?>
    ...
    <div id="footer">
      <p><a href="index.php"><label class="footer_menu">Home</label></a> | <a href="about_us.php">About Us</a> | <a href="products.php">Products</a> | <a href="branches.php">Branches</a> | <a href="contact.php">Contact Us</a> | <a href="faq.php">FAQ</a> | <a href="news_event.php">News and Event</a></p>
