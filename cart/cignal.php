...
<!--script-->
	  ...
	  <div id="sidebar_container">
		...
		<div class="side_bar">	
			<a href="cignal.php" class="sidebar_menu_active"><img src="images/icon/cgnal.png" width="33" alt="Phones">&nbsp;&nbsp;Cignal HD TV</a>
		</div>
          </div>
        </div>
...
$result= mysql_query("select * from products where product_type='Cignal HD TV'  and product_status='Available' order by product_id ASC") or die (mysql_error());
